...
class CreateSivSubItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('siv_sub_items', function (Blueprint $table) {
            $table->id();
			$table->foreignId('vsi_id')->constrained('section_item_values')
				  ->onDelete('cascade')
				  ->onUpdate('no action');
    ...
    {
        Schema::dropIfExists('siv_sub_items');
    }
}
